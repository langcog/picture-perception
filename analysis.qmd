...
mod_pic <- glm(accuracy ~ pic_interact + play + talk + toy_num + maternal_ed,
              data = d, family = "binomial")
summary(mod_pic)
#all null effects

mod_pic_age <- glm(accuracy ~ pic_interact * age_centered + play + talk + toy_num + maternal_ed,
              data = d, family = "binomial")
summary(mod_pic_age)
#large main effect of age
#marginal effect of pic interaction x age! p = .07
...
mod_pic_only <- glm(accuracy ~ pic_interact + play + talk + toy_num + maternal_ed,
              data = pic_condition, family = "binomial")
summary(mod_pic_only)
#all null effects

mod_pic_only_age <- glm(accuracy ~ pic_interact * age_centered + play + talk + toy_num + maternal_ed,
              data = pic_condition, family = "binomial")
