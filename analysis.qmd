...
mod_pic <- glmer(accuracy ~ pic_interact + play + talk + toy_num + maternal_ed + (1 | target_word),
              data = d, family = "binomial")
summary(mod_pic)
#all null effects

mod_pic_age <- glmer(accuracy ~ pic_interact * age_centered + play + talk + toy_num + maternal_ed + (1 | target_word),
              data = d, family = "binomial")
summary(mod_pic_age)
#large main effect of age
#effect of pic interaction x age! p = .03
...
mod_pic_only <- glmer(accuracy ~ pic_interact + play + talk + toy_num + maternal_ed + (1 | target_word),
              data = pic_condition, family = "binomial")
summary(mod_pic_only)
#all null effects

mod_pic_only_age <- glmer(accuracy ~ pic_interact * age_centered + play + talk + toy_num + maternal_ed + (1 | target_word),
              data = pic_condition, family = "binomial")
