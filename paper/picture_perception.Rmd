...
Furthermore, exploratory analyses examining children’s error patterns allow for another view of the present data, beyond binary correct/incorrect scoring. Specifically, if children’s errors consist primarily of near distractors, they may still have some degree of understanding of the task at hand. However, if children’s errors consist primarily of random distractors, they may have a substantial amount of difficulty with either the target word, the stimuli format, or both. Preliminary exploratory error analyses suggest that younger children tend to make more near distractor errors than random distractor errors when presented with objects, potentially suggesting a greater degree of understanding in the object condition than the picture conditions. However, more analyses, especially controlling for item effects, are necessary in order to strongly draw this conclusion.
